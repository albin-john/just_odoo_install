...
# sudo nano /etc/postgresql/<your postgresql version>/main/pg_hba.conf
# For example:

# TYPE  DATABASE        USER                 ADDRESS                 METHOD

# host    all      <db user or all>          0.0.0.0/0               trust
...
sudo su root -c "printf 'logfile = $OE_HOME/${OE_CONFIG}.log\n' >> $OE_HOME/${OE_CONFIG}.conf"
